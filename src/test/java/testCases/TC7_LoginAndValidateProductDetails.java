...
public class TC7_LoginAndValidateProductDetails extends BaseClass
{
	
	@Test
	public void productDetailsValidation() throws EncryptedDocumentException, IOException{
		...
		ScreenshotUtil.screenshot(driver, productDetails);
